<main class="content">
  ...
  <form class="mt-5" action="innout.php" method="post">
    <div class="input-group no-border">
      <input type="text" name="forcedTime" class="form-control" placeholder="Simule a hora de batimento">
      <button class="btn btn-danger ml-3">Simular Ponto</button>
    </div>
    <a href="data_generator.php" class="btn btn-info mt-5 text-light">Gerar massa de dados</a>
    <a href="test.php" class="btn btn-info mt-5 text-light">Teste</a>
  </form>
</main>